...
"[project]/src/lib/api/productApi.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const createProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("create/product", async (formData, thunkAPI)=>{
    try {
        const { data: result } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2f$axiosInstance$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post("api/products", formData);
        return result;
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$productApi$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api/productApi.ts [app-rsc] (ecmascript)");
...
;
const ProductPage = ()=>{
    const { products, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$hooks$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useAppSelector"])((state)=>state.products);
    console.log("🚀 ~ ProductPage ~ products:", products);
    const dispatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$hooks$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useAppDispatch"])();
    const handleCreate = async ()=>{
        ...
        try {
            const resultAction = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$productApi$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createProduct"])(formData));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$productApi$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createProduct"].fulfilled.match(resultAction)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d0e6692._.js.map