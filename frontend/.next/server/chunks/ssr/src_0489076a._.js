...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$hooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/redux/hooks.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$customers$2f$page$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/customers/page.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
const Post = ()=>{
    const disaptch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$hooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAppDispatch"])();
    const { posts, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$hooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAppSelector"])((state)=>state.posts);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchPosts = async ()=>{
            if (posts.length === 0) {
                await disaptch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPosts"])());
            }
        };
        fetchPosts();
    }, [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        console.log(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$customers$2f$page$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]);
    }, [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$customers$2f$page$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
    ]);
    const handleCreate = async ()=>{
        const post = {
        ...
        try {
            const resultAction = await disaptch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPost"])({
                data: post
            }));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPost"].fulfilled.match(resultAction)) {
    ...
    const handleUpdate = async ()=>{
        ...
        try {
            const resultAction = await disaptch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updatePosts"])({
                id: Id,
                data: updatePost
            }));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updatePosts"].fulfilled.match(resultAction)) {
    ...
    const handleDelete = async ()=>{
        const Id = "68a18d619e37289c04cbe893";
        try {
            const resultAction = await disaptch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deletePost"])({
                Id
            }));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deletePost"].fulfilled.match(resultAction)) {
...
//# sourceMappingURL=src_0489076a._.js.map