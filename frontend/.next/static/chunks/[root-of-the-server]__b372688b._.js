...
;
;
const createPost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("create/post", async (param, thunkAPI)=>{
    let { data } = param;
    try {
        const { data: result } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("api/posts", data);
        return result;
    } catch (error) {
        const errorMessage = (error === null || error === void 0 ? void 0 : error.response.data.message) || error.message || "Something went wrong";
        return thunkAPI.rejectWithValue(errorMessage);
...
const getPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("get/post", async (_, thunkAPI)=>{
    try {
        const { data: result } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("api/posts");
        return result;
    } catch (error) {
        const errorMessage = (error === null || error === void 0 ? void 0 : error.response.data.message) || error.message || "something went wrong";
        return thunkAPI.rejectWithValue(errorMessage);
...
const updatePosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("update/posts", async (param, thunkAPI)=>{
    let { id, data } = param;
    try {
        const { data: result } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("api/posts/".concat(id), data);
        return result;
    } catch (error) {
        const errorMessage = (error === null || error === void 0 ? void 0 : error.response.data.message) || error.message || "something went wrong";
        return thunkAPI.rejectWithValue(errorMessage);
...
const deletePost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("delete/post", async (param, thunkAPI)=>{
    let { Id } = param;
    try {
        const { data: result } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("api/posts/".concat(Id));
        return result;
    } catch (error) {
        const errorMessage = error.response.data.message || error.message || "Something Went Wrong";
        return thunkAPI.rejectWithValue(errorMessage);
...
"[project]/src/redux/slices/postSlice.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const postSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    extraReducers (builder) {
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPost"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPosts"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updatePosts"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deletePost"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPost"].fulfilled, (state, action)=>{
            state.loading = false;
            state.posts = action.payload.posts;
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPost"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload || action.error.message || "Error creating post";
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPosts"].fulfilled, (state, action)=>{
            state.loading = false;
            state.posts = action.payload.posts;
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPosts"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload || action.error.message || "Failed to fetch";
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updatePosts"].fulfilled, (state, action)=>{
            state.loading = false;
            const index = state.posts.findIndex((i)=>i._id === action.payload._id);
            state.posts[index] = action.payload;
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updatePosts"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload || action.error.message || "failed to update post";
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deletePost"].fulfilled, (state, action)=>{
            state.loading = false;
            state.posts = state.posts.filter((i)=>i._id !== action.payload.id);
        });
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$postApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deletePost"].rejected, (state, action)=>{
            state.loading = false;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$slices$2f$postSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/redux/slices/postSlice.ts [app-client] (ecmascript)");
;
;
;
;
const rootReducer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2f$dist$2f$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineReducers"])({
    ...
    posts: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$slices$2f$postSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b372688b._.js.map